...
public class Jeu {
    ...
    public void demarrerTour() {
        ...
        while (joueurActuel.getPointsDeVie() > 0 && joueurPres.getPointsDeVie() > 0 && joueurPres.getPopularite() < 5 && joueurActuel.getPopularite() < 5 && !pioche.piocheVide() && !finDuJeuTrouvee) {
